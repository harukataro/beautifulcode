...
こんばんは。みなさんお元気？こんな正月から盛り上がっているようだから覗いてみようかしら。早速今日の問題はこちら。もし競技プログラミングたしなむのだったら一緒に考えてみてね。
...
問題を先生が日本語で解説してあげる**１０以下の素数は 2,3,5,7 です。その和は 17 になります。与えられた N より小さい素数の和を求めなさい.** 簡単ね。チョチョイのチョイよね。部員たちよ。でもこの子たち 1 月 1 日からこんなことしててもしかして非モテかしら www
